...
class DeepSeekClient:
    ...
    async def complete(
        ...
        try:
            ...
            # openai.OpenAI (used here for its OpenAI-compatible API) is a
            # synchronous client; offload to a thread so this call doesn't
            # block the event loop (see openai_client.py for the full
            # rationale).
